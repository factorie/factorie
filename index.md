...
The current recommended FACTORIE source code is version **{{ site.factorie_version }}**, available for download [here](download.html).  You can also obtain our latest code changes through the [GitHub repository](git clone https://github.com/factorie/factorie). Although pre-1.0, it is already extremely useful and quite stable. You can also browse our [list of outstanding issues](http://code.google.com/p/factorie/issues/list).
