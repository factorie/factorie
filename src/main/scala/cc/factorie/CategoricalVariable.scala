...
trait CategoricalVar[V<:CategoricalValue[C],C] extends DiscreteVar with CategoricalTensorVar[C] with ValueBound[CategoricalValue[C]] with VarWithDomain[CategoricalValue[C]]  {
