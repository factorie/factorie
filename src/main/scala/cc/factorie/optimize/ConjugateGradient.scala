...
class ConjugateGradient(val optimizable: OptimizableByValueAndGradient, initialStepSize:Double = 0.01) extends Optimizer with FastLogging {
  ...
  var fp = 0.0; var gg = 0.0; var gam = 0.0; var dgg = 0.0; var step = 0.0; var fret = 0.0
  var xi: Array[Double] = null; var g:Array[Double] = null; var h:Array[Double] = null
  var iterations = 0
