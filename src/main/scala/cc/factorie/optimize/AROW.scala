...
class AROW(model:Model2[_], learningMargin:Double = 1.0, val lambdaAROW:Double=1.0) extends ConfidenceWeighting(model,learningMargin) {
...
class ConfidenceWeighting(val model:Model2[_], var learningMargin:Double=1.0) extends GradientOptimizer {
