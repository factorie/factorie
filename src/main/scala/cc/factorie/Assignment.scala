...
trait AbstractAssignment2[A<:Variable,B<:Variable] extends Assignment {
  ...
  override def globalize(implicit d:DiffList): Unit = {
    var1 match { case v:MutableVar => v.set(value1.asInstanceOf[v.Value]) }
    var2 match { case v:MutableVar => v.set(value2.asInstanceOf[v.Value]) }
  }
}
...
trait AbstractAssignment3[A<:Variable,B<:Variable,C<:Variable] extends Assignment {
  ...
  def apply[X<:Variable](v:X): X#Value = if (v eq var1) value1.asInstanceOf[X#Value] else if (v eq var2) value2.asInstanceOf[X#Value] else if (v eq var3) value3.asInstanceOf[X#Value] else null.asInstanceOf[X#Value]
  ...
  override def globalize(implicit d:DiffList): Unit = {
    var1 match { case v:MutableVar => v.set(value1.asInstanceOf[v.Value]) }
    var2 match { case v:MutableVar => v.set(value2.asInstanceOf[v.Value]) }
    var3 match { case v:MutableVar => v.set(value3.asInstanceOf[v.Value]) }
  }
}
...
trait AbstractAssignment4[A<:Variable,B<:Variable,C<:Variable,D<:Variable] extends Assignment {
  ...
  def apply[X<:Variable](v:X): X#Value = if (v eq var1) value1.asInstanceOf[X#Value] else if (v eq var2) value2.asInstanceOf[X#Value] else if (v eq var3) value3.asInstanceOf[X#Value] else if (v eq var4) value4.asInstanceOf[X#Value] else null.asInstanceOf[X#Value]
  ...
  override def globalize(implicit d:DiffList): Unit = {
    ...
    var2 match { case v:MutableVar => v.set(value2.asInstanceOf[v.Value]) }
    var3 match { case v:MutableVar => v.set(value3.asInstanceOf[v.Value]) }
    var4 match { case v:MutableVar => v.set(value4.asInstanceOf[v.Value]) }
  }
}
/** An efficient Assignment of three variables.
    @author Andrew McCallum */
