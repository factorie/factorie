...
/** Tries each one of the settings in the Iterator provided by the abstract method "settings(C), 
    ...
    @author Andrew McCallum */
abstract class SettingsSampler[C](theModel:Model2[Variable], theObjective:Model2[Variable] = null) extends ProposalSampler[C] with SettingsSampler0 {
...
abstract class SettingsGreedyMaximizer[C](theModel:Model2[Variable], theObjective:Model2[Variable] = null) extends SettingsSampler[C](theModel, theObjective) {
...
/** Tries each one of the settings of the given variable, 
    ...
    @author Andrew McCallum */
class VariableSettingsSampler[V<:Variable with IterableSettings](model:Model2[Variable], objective:Model2[Variable] = null) extends SettingsSampler[V](model, objective) {
  def settings(v:V): SettingIterator = v.settings
}

// TODO Remove and recommend GibbsSampler instead
class VariablesSettingsSampler[V<:Variable with IterableSettings](model:Model2[Variable], objective:Model2[Variable] = null) extends SettingsSampler[Seq[V]](model, objective) {
...
class VariableSettingsGreedyMaximizer[V<:Variable with IterableSettings](model:Model2[Variable], objective:Model2[Variable] = null) extends SettingsGreedyMaximizer[V](model, objective) {
  def settings(v:V): SettingIterator = v.settings
}
