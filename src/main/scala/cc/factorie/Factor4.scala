...
//  def statistics(v:Values): StatisticsType
  ...
  def statistics: StatisticsType = statistics(_1.value, _2.value, _3.value, _4.value)
  ...
  def currentAssignment = new Assignment4(_1, _1.value, _2, _2.value, _3, _3.value, _4, _4.value)
