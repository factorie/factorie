...
object Gamma extends GenerativeFamily3[GeneratedRealVar,GeneratedRealVar,GeneratedRealVar] {
  self =>
  ...
  def newFactor(_1:GeneratedRealVar, _2:GeneratedRealVar, _3:GeneratedRealVar) = Factor(_1, _2, _3)
}
