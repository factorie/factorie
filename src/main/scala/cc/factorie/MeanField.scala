...
class DiscreteMeanField[V<:DiscreteVariable](val model:Model2[Variable], val summary:DiscreteSummary1[V]) extends MeanField {
  def this(vs:Iterable[V], model:Model2[Variable]) = this(model, new DiscreteSummary1(vs))
...
class InferByMeanField {
  def inferencer[V<:DiscreteVariable](variables:Iterable[V], model:Model2[Variable]): DiscreteMeanField[V] = new DiscreteMeanField(variables, model)
  def apply[V<:DiscreteVariable](variables:Iterable[V], model:Model2[Variable]): DiscreteSummary1[V] = {
