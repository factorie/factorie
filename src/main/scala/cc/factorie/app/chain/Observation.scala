...
object Observations {
  ...
  def addNeighboringFeatures[A<:Observation[A]](observations:Seq[A], vf:A=>CategoricalDimensionTensorVar[String], preOffset:Int, postOffset:Int): Unit = {
  ...
  def addFeatures[A<:Observation[A]](observations:Seq[A], vf:A=>CategoricalDimensionTensorVar[String], f1:A=>String, i1:Int): Unit = {
  ...
  def addFeatures[A<:Observation[A]](observations:Seq[A], vf:A=>CategoricalDimensionTensorVar[String], f1:A=>String, i1:Int, f2:A=>String, i2:Int): Unit = {
    for (i <- 0 until observations.length) {
      val o = observations(i)
      val o1 = safeApply(observations, i+i1); val s1 = if (o1 ne null) f1(o1) else null
  ...
  def addFeatures[A<:Observation[A]](observations:Seq[A], vf:A=>CategoricalDimensionTensorVar[String], f1:A=>String, i1:Int, f2:A=>String, i2:Int, f3:A=>String, i3:Int): Unit = {
    for (i <- 0 until observations.length) {
      val o = observations(i)
      val o1 = safeApply(observations, i+i1); val s1 = if (o1 ne null) f1(o1) else null
      val o2 = safeApply(observations, i+i2); val s2 = if (o2 ne null) f2(o2) else null
  ...
  def addNeighboringFeatureConjunctions[A<:Observation[A]](observations:Seq[A], vf:A=>CategoricalDimensionTensorVar[String], offsetConjunctions:Seq[Int]*): Unit =
  ...
  def addNeighboringFeatureConjunctions[A<:Observation[A]](observations:Seq[A], vf:A=>CategoricalDimensionTensorVar[String], regex:String, offsetConjunctions:Seq[Int]*): Unit = {
  ...
  private def appendConjunctions[A<:Observation[A]](t:A, vf:A=>CategoricalDimensionTensorVar[String], regex:String, existing:ArrayBuffer[List[(String,Int)]], offsets:Seq[Int]): ArrayBuffer[List[(String,Int)]] = {
