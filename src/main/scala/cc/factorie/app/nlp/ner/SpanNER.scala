...
// The sampler
class TokenSpanSampler(model:Model2[Variable], objective:Model2[Variable]) extends SettingsSampler[Token](model, objective) {
...
class SpanNerPredictor(model:Model2[Variable]) extends TokenSpanSampler(model, null) {
