...
import cc.factorie.app.nlp.phrase.NounPhrase
...
class Mention(section:Section, start:Int, length:Int, val headTokenIndex: Int = -1) extends NounPhrase(section,start,length) with Attr {
