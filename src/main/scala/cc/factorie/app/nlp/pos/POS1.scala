...
class POS1 extends DocumentAnnotator {
  ...
  def train(trainDocs:Seq[Document], testDocs:Seq[Document], lrate:Double = 0.1, decay:Double = 0.01, cutoff:Int = 2, doBootstrap:Boolean = true, useHingeLoss:Boolean = false, numIterations: Int = 2, l1Factor:Double = 0.000001, l2Factor:Double = 0.000001)(implicit random: scala.util.Random) {
