...
object NLP {
  ...
  def main(args:Array[String]): Unit = {
    ...
    object opts extends cc.factorie.util.DefaultCmdOptions {
      ...
      val parseforwardcoref = new CmdOption[String]("parse-forward-coref", null, "URL", "Annotate within-document noun mention coreference using a state-of-the-art system and parse-based mention finding") { override def invoke() = {  if (value ne null) System.setProperty(classOf[coref.ForwardCoref].getName, value); annotators += cc.factorie.app.nlp.coref.ParseForwardCoref } }
      ...
      val forwardcoref = new CmdOption[String]("forward-coref-trainer", null, "URL", "Annotate within-document proper- and pro-noun mention coreference using a state-of-the-art system") { override def invoke() = { if (value ne null) System.setProperty(classOf[coref.ForwardCoref].getName, value); annotators += coref.ParseForwardCoref} }
