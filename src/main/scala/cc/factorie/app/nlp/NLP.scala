...
object NLP {
  ...
  def main(args:Array[String]): Unit = {
    object opts extends cc.factorie.util.DefaultCmdOptions {
      ...
      val pos1 = new CmdOption("pos1", ClasspathURL[pos.POS1]("-WSJ.factorie").toString, "URL", "Annotate POS") { override def invoke = { System.setProperty(classOf[pos.POS1].getName, value); println("NLP setting POS1 "+value); annotators += cc.factorie.app.nlp.pos.POS1 } }
      //val pos1 = new CmdOption("pos1", "classpath:cc/factorie/app/nlp/pos/POS1-WSJ.factorie", "URL", "Annotate POS") { override def invoke = { System.setProperty(classOf[pos.POS1].getName, value); println("NLP setting POS1 "+value); annotators += cc.factorie.app.nlp.pos.POS1 } }
      //val pos1 = new CmdOption("pos1", "file:/Users/mccallum/workspace/factorie-nlp-resources/src/main/resources/cc/factorie/app/nlp/pos/POS1-WSJ.factorie", "URL", "Annotate POS") { override def invoke = { System.setProperty(classOf[pos.POS1].getName, value); println("NLP setting POS1 "+value); annotators += cc.factorie.app.nlp.pos.POS1 } }
