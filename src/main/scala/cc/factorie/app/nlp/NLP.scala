...
object NLP {
  ...
  def main(args:Array[String]): Unit = {
    object opts extends cc.factorie.util.DefaultCmdOptions {
      ...
      val ner2 = new CmdOption("ner2", ClasspathURL[ner.NER2](".factorie").toString, "URL", "Annotate Ontonotes NER")  { override def invoke = { System.setProperty(classOf[ner.NER2].getName, value); annotators += cc.factorie.app.nlp.ner.NER2 } }
