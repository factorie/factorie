...
//
//
//    public SpanishTokenizer(Reader r, boolean splitCompounds, boolean splitVerbs, boolean splitContractions) {
//        lexer = new SpanishLexer(r);
...
//        try {
//            SpanishTokenizer tokenizer = tf.getTokenizer(new InputStreamReader(System.in, encoding));
